...
Use `layout: full-width` for a polished project page driven by front matter. It supports a hero section, achievement tiles, feature bands, card grids for media/projects/news, people and impact sections, optional section action buttons, and partner logos.
